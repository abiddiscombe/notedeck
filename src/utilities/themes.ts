...
export const themes: {
  ...
  blue: {
    ...
    noteOpaque: "bg-sky-100 dark:bg-sky-950 [&>div]:bg-sky-200 dark:[&>div]:bg-sky-800",
    selectionButton:
  ...
  green: {
    ...
    noteOpaque: "bg-green-100 dark:bg-green-950 [&>div]:bg-green-200 dark:[&>div]:bg-green-800",
    selectionButton:
  ...
  yellow: {
    ...
    noteOpaque: "bg-amber-100 dark:bg-amber-950 [&>div]:bg-amber-200 dark:[&>div]:bg-amber-800",
    selectionButton:
  ...
  purple: {
    ...
    noteOpaque: "bg-purple-100 dark:bg-purple-950 [&>div]:bg-purple-200 dark:[&>div]:bg-purple-800",
    selectionButton:
